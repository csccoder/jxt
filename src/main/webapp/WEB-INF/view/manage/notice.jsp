...
<div class="container">
    ...
    <div class="row">
        ...
        <div id="contentPanel" class="pull-left" style=" margin-left: 30px;width: 910px">
            <h4 style="background-color: #f5f5f5; height: 35px; line-height: 35px;margin: 0px; padding-left: 10px; color:  #555555; font-size: 16px;margin-bottom: 20px;">
                <i class="fa fa-user-circle-o" style="padding: 0 10px;color: #ff8f2b"></i>公告管理</h4>
            <div class="main container">

                <div class="row">
                    <ul id="toolbar">
                        <li><button type="button" class="btn btn-success" id="add">新增</button></li>
    ...
    <!--公告模态框-->
    <div class="modal fade" id="noticeInfoModal" tabindex="-1" role="dialog" aria-labelledby="studentInfoModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="noticeInfoModalLabel">编辑公告信息</h4>
                </div>
                <div class="modal-body">
                    <form class="form-horizontal" id="noticeForm">
                        <input type="hidden" id="inputNoticeId" name="id" disabled="disabled">
                        <div class="form-group">
                            <label for="inputNoticeTitle" class="col-sm-2 control-label">公告标题</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputNoticeTitle" placeholder="公告标题" name="title">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="inputNoticeContent" class="col-sm-2 control-label">公告内容</label>
                            <div class="col-sm-10">
                                <textarea class="form-control" rows="5" id="inputNoticeContent" placeholder="请填写公告内容" name="content"></textarea>
                            </div>
                        </div>
    ...
    <!--公告详细模态框-->
    <!-- Small modal -->
    <div class="modal fade" id="noticeDetailModal" tabindex="-1" role="dialog" aria-labelledby="noticeDetailModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<script src="${prefix}/js/noticeManage.js"></script>
</body>
</html>