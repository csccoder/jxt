    ...
    <div class="row">
        ...
        <div id="contentPanel" class="pull-left" style=" margin-left: 30px;width: 910px">
            ...
            <h4 style="background-color: #f5f5f5; height: 35px; line-height: 35px;margin: 0px; padding-left: 10px; color:  #555555; font-size: 16px;margin-bottom: 20px;">
                <i class="fa fa-bookmark-o" style="padding: 0 10px;color: #ff8f2b"></i>我的分享</h4>
            <div class="main">
                <ul id="mainContent" class="normalUl">
                    <c:choose>
                        <c:when test="${pageHelper.data ne null}">
                            <c:forEach var="share" items="${pageHelper.data}">
                                <li><a href="${prefix}/rest/share/${share.id}">【${share.category.categoryName}】${share.title}</a><i>&gt;&gt;</i></li>
                            </c:forEach>
                        </c:when>
                        <c:otherwise>
                        ...
                        <ul>
                            <c:choose>
                                ...
                                <c:when test="${pageHelper.curPage eq 1}">
                                    ...
                                    <li><a href="${prefix}/rest/manage/share?curPage=${pageHelper.nextPage}&pageSize=${pageHelper.pageSize}">下一页</a></li>
                                    <li><a href="${prefix}/rest/manage/share?curPage=${pageHelper.last}&pageSize=${pageHelper.pageSize}">末页</a></li>
                                </c:when>
                                <c:when test="${pageHelper.curPage eq pageHelper.last}">
                                    <li><a href="${prefix}/rest/manage/share?curPage=${pageHelper.first}&pageSize=${pageHelper.pageSize}">首页</a></li>
                                    <li><a href="${prefix}/rest/manage/share?curPage=${pageHelper.prePage}&pageSize=${pageHelper.pageSize}">上一页</a></li>
                                    <li><input type="text" value="${pageHelper.curPage}" min="1" max="${pageHelper.last}">/${pageHelper.last}</li>
                                    <li><a>下一页</a></li>
                                    <li><a >末页</a></li>
                                </c:when>
