                            ...
                            <ul>
                                <c:choose>
                                    ...
                                    <c:when test="${pageHelper.curPage eq 1}">
                                        ...
                                        <li><a href="${prefix}/rest/teacher/share?curPage=${pageHelper.nextPage}&pageSize=${pageHelper.pageSize}">下一页</a></li>
                                    ...
                                    <c:when test="${pageHelper.curPage eq pageHelper.last}">
                                        <li><a href="${prefix}/rest/teacher/share?curPage=${pageHelper.first}&pageSize=${pageHelper.pageSize}">首页</a></li>
                                        <li><a href="${prefix}/rest/teacher/share?curPage=${pageHelper.prePage}&pageSize=${pageHelper.pageSize}">上一页</a></li>
                                        <li><input type="text" value="${pageHelper.curPage}" min="1" max="${pageHelper.last}">/${pageHelper.last}</li>
                                        <li><a>下一页</a></li>
                                        <li><a >末页</a></li>
                                    </c:when>
                                    <c:otherwise>
                                        ...
                                        <li><input type="text" value="${pageHelper.curPage}" min="1" max="${pageHelper.last}">/${pageHelper.last}</li>
                                        <li><a href="${prefix}/rest/teacher/share?curPage=${pageHelper.nextPage}&pageSize=${pageHelper.pageSize}">下一页</a></li>
                                        <li><a href="${prefix}/rest/teacher/share?curPage=${pageHelper.last}&pageSize=${pageHelper.pageSize}">末页</a></li>
                                    </c:otherwise>
                                </c:choose>
                            </ul>
                        </div>
